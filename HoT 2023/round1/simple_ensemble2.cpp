...
vector<vector<MSG> > strategy2(map<int, queue<MSG> > messages, int m, int c, vector<int> &user_execution_time)
{
...
int main()
{
    ...
    auto distribution2 = strategy2(messages, m, c, user_execution_time);
